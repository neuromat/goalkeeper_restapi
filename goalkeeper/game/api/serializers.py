...
from game.models import GameConfig, GoalkeeperGame, Context, Probability, Level
...
class GameSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'config', 'number_of_directions', 'number_of_plays', 'min_hits', 'min_hits_in_seq', 'sequence',
                  ...
                  'depth', 'seq_step_det_or_prob', 'show_history', 'send_markers_eeg', 'port_eeg_serial', 'score')
