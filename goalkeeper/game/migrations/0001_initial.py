# Generated by Django 2.2 on 2019-05-27 14:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_score_board', models.CharField(choices=[('long', 'Long'), ('short', 'Short'), ('none', 'None')], default='short', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('context', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='game.Context')),
            ],
        ),
        migrations.CreateModel(
            name='GameConfig',
        ...
        migrations.AddField(
            model_name='context',
            name='goalkeeper',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='game.GoalkeeperGame'),
        ),
    ]
