    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_directions', models.IntegerField(choices=[(2, '2 - left and right'), (3, '3 - left, center and right')], default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_seq_manually', models.CharField(choices=[('no', 'No'), ('yes', 'Yes')], default='no', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.CharField(choices=[('no', 'No'), ('yes', 'Yes')], default='no', max_length=3, verbose_name='Is it public?')),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='game.Level', verbose_name='Level')),
            ],
            options={
