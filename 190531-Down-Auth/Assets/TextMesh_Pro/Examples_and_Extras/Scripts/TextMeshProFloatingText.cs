    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                //m_textMeshPro.fontAsset = Resources.Load("Fonts_and_Materials/JOKERMAN SDF", typeof(TextMeshProFont)) as TextMeshProFont; // User should only provide a string to the resource.
                //m_textMeshPro.fontSharedMaterial = Resources.Load("Fonts_and_Materials/LiberationSans_SDF", typeof(Material)) as Material;
